  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Agency specific variants
        cta: "border border-foreground bg-transparent text-foreground rounded-full px-6 py-2.5 hover:bg-foreground hover:text-background font-medium",
        "cta-primary": "bg-foreground text-background rounded-full px-8 py-3 hover:bg-foreground/90 font-display font-semibold",
        floating: "bg-background text-foreground rounded-full shadow-lg border border-border hover:shadow-xl hover:scale-105",
      },
      size: {
